...
export const UserDetails = (state = {
    errMess: null,
    authenticated: !!window.localStorage.getItem("user"),
    ...
    switch (action.type) {
        case ActionTypes.LOGIN_SUCCESS:
            ...
            return {
                ...state, errMess: null, authenticated: true, user: action.payload.user,
            };

        case ActionTypes.LOGIN_FAILED:
            return {
                ...state, errMess: action.payload, authenticated: false, user: null,
            };
